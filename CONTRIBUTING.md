...
Integration tests require a working Juju LXD controller. We **assume** you already have these set up. If not, refer to the official [juju](https://documentation.ubuntu.com/juju) documentation.
